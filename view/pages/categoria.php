...
<body class="container-adm">
    ...
    <main class="content-adm">
        ...
        <div class="container">
            <form class="form" method="POST" action="<?= APP_CONSTANTS['APP_URL'] . APP_CONSTANTS['PATH_PAGES'] . 'pages/categoria_salvar.php' ?>">
                ...
                <div class="form-actions">
                    <a href="<?= APP_CONSTANTS['APP_URL'] . APP_CONSTANTS['PATH_PAGES'] . 'pages/categorias.php' ?>">
